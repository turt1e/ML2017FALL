...
# fits the model on batches with real-time data augmentation:
   ...
   # for i in range(epochss):
    ...
    model.fit(train_pixels,train_labels,batch_size=128,epochs=25,validation_data=(val_pixels/255,val_labels))
  ...
  #  out=open('predict.csv','w')
   # out.write('id,value\n')
    np.savetxt('predict.csv',yl,fmt='%d',delimiter=',',header='id,label',comments='')
